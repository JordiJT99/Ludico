...
const trueFalseFacts = [
  ...
  trueFalse("La Luna es un planeta.", false, "La Luna es el satélite natural de la Tierra.", "Ciencia", 1, "https://science.nasa.gov/moon/"),
  trueFalse("El agua es un elemento químico.", false, "El agua es un compuesto formado por hidrógeno y oxígeno.", "Ciencia", 1, "https://www.usgs.gov/special-topics/water-science-school/science/water-properties"),
  trueFalse("Los murciélagos son mamíferos.", true, "Los murciélagos pertenecen al grupo de los mamíferos.", "Naturaleza", 1, "https://www.britannica.com/animal/bat-mammal"),
  trueFalse("El Sol gira alrededor de la Tierra.", false, "La Tierra orbita alrededor del Sol.", "Ciencia", 1, "https://science.nasa.gov/sun/"),
  trueFalse("Roma es la capital de Italia.", true, "Roma es la capital italiana.", "Geografía", 1, "https://www.italia.it/es"),
  trueFalse("El océano Pacífico es más pequeño que el Ártico.", false, "El Pacífico es el océano más extenso de la Tierra.", "Geografía", 1, "https://oceanservice.noaa.gov/facts/largest-ocean.html"),
  trueFalse("La luz viaja más rápido que el sonido en el aire.", true, "La luz llega antes que el sonido en fenómenos como los relámpagos.", "Ciencia", 1, "https://www.nist.gov/pml/speed-light"),
  trueFalse("Cervantes escribió La Odisea.", false, "La Odisea se atribuye a Homero; Cervantes escribió Don Quijote.", "Literatura", 1, "https://www.cervantes.es/"),
  trueFalse("Un triángulo tiene cuatro lados.", false, "Un triángulo tiene exactamente tres lados.", "Matemáticas", 1, "https://www.britannica.com/science/triangle"),
  trueFalse("El símbolo químico del oro es Au.", true, "Au procede del nombre latino aurum.", "Ciencia", 1, "https://www.rsc.org/periodic-table/element/79/gold"),
  trueFalse("Durante la fotosíntesis las plantas absorben principalmente oxígeno.", false, "Las plantas usan dióxido de carbono durante la fotosíntesis.", "Naturaleza", 1, "https://science.nasa.gov/earth/"),
  trueFalse("Venus es el planeta más caliente del sistema solar.", true, "Su densa atmósfera retiene mucho calor.", "Ciencia", 1, "https://science.nasa.gov/venus/"),
  trueFalse("Mercurio es el planeta más grande del sistema solar.", false, "Júpiter es el planeta de mayor tamaño.", "Ciencia", 1, "https://science.nasa.gov/jupiter/"),
  trueFalse("Los pulpos tienen tres corazones.", true, "Los pulpos poseen dos corazones branquiales y uno sistémico.", "Naturaleza", 1, "https://ocean.si.edu/ocean-life/invertebrates/octopuses-and-squids"),
  trueFalse("La Antártida es un continente.", true, "La Antártida es el continente situado alrededor del polo sur.", "Geografía", 1, "https://www.britannica.com/place/Antarctica"),
  trueFalse("El desierto del Sahara es una selva tropical.", false, "El Sahara es un gran desierto del norte de África.", "Geografía", 1, "https://www.britannica.com/place/Sahara-desert-Africa"),
  trueFalse("El Everest está en África.", false, "El Everest se encuentra en la cordillera del Himalaya.", "Geografía", 1, "https://www.britannica.com/place/Mount-Everest"),
  trueFalse("El sonido suele viajar más rápido en agua que en aire.", true, "La velocidad del sonido depende del medio por el que se propaga.", "Ciencia", 1, "https://www.nist.gov/pml"),
  trueFalse("H₂O es la fórmula del dióxido de carbono.", false, "H₂O representa agua; el dióxido de carbono es CO₂.", "Ciencia", 1, "https://www.usgs.gov/special-topics/water-science-school/science/water-properties"),
  trueFalse("Un cuadrado tiene tres lados.", false, "Un cuadrado tiene cuatro lados iguales.", "Matemáticas", 1, "https://www.britannica.com/science/square-geometry"),
  trueFalse("Los pingüinos son aves.", true, "Los pingüinos son aves adaptadas a la vida acuática.", "Naturaleza", 1, "https://www.britannica.com/animal/penguin"),
  trueFalse("Todas las ballenas son peces.", false, "Las ballenas son mamíferos marinos.", "Naturaleza", 1, "https://www.britannica.com/animal/whale"),
  trueFalse("La atmósfera terrestre está compuesta principalmente por oxígeno.", false, "El nitrógeno es el gas más abundante en la atmósfera.", "Ciencia", 1, "https://science.nasa.gov/earth/"),
  trueFalse("Un año tiene doce meses.", true, "El calendario civil divide el año en doce meses.", "Vida cotidiana", 1, "https://www.britannica.com/science/calendar"),
  trueFalse("Una hora tiene sesenta minutos.", true, "La división convencional de una hora es de sesenta minutos.", "Vida cotidiana", 1, "https://www.britannica.com/science/time-measurement"),
  trueFalse("Una semana tiene ocho días.", false, "La semana convencional tiene siete días.", "Vida cotidiana", 1, "https://www.britannica.com/science/week"),
  trueFalse("Los anillos de Saturno contienen principalmente partículas de hielo.", true, "Los anillos están compuestos en gran parte por hielo y polvo.", "Ciencia", 1, "https://science.nasa.gov/saturn/"),
  trueFalse("Júpiter es más pequeño que Marte.", false, "Júpiter es mucho mayor que Marte.", "Ciencia", 1, "https://science.nasa.gov/jupiter/"),
  trueFalse("El ADN es una molécula.", true, "El ADN almacena información genética en los seres vivos.", "Ciencia", 1, "https://www.genome.gov/genetics-glossary/DNA"),
  trueFalse("Madrid es la capital de España.", true, "Madrid es la capital del Estado español.", "Geografía", 1, "https://www.lamoncloa.gob.es/espana/"),
  trueFalse("Lisboa es la capital de Francia.", false, "Lisboa es la capital de Portugal; París es la de Francia.", "Geografía", 1, "https://www.britannica.com/place/Lisbon"),
  trueFalse("El Nilo es un río.", true, "El Nilo es un gran río del noreste de África.", "Geografía", 1, "https://www.britannica.com/place/Nile-River"),
  trueFalse("Un hexágono tiene seis lados.", true, "Un hexágono es un polígono de seis lados.", "Matemáticas", 1, "https://www.britannica.com/science/hexagon"),
  trueFalse("Un piano produce sonido mediante cuerdas.", true, "En un piano los martillos golpean cuerdas tensas.", "Música", 1, "https://www.britannica.com/art/piano-musical-instrument"),
  trueFalse("Un violín es un instrumento de metal.", false, "El violín es un instrumento de cuerda frotada.", "Música", 1, "https://www.britannica.com/art/violin"),
  trueFalse("El agua se congela a 0 °C a presión atmosférica normal.", true, "El punto de congelación del agua se toma como referencia de la escala Celsius.", "Ciencia", 1, "https://www.nist.gov/pml"),
  trueFalse("El océano Pacífico está enteramente en el hemisferio norte.", false, "El Pacífico se extiende por ambos hemisferios.", "Geografía", 1, "https://oceanservice.noaa.gov/facts/largest-ocean.html"),
  trueFalse("La clorofila participa en la fotosíntesis.", true, "La clorofila absorbe luz para impulsar la fotosíntesis.", "Naturaleza", 1, "https://science.nasa.gov/earth/"),
  trueFalse("Una brújula apunta siempre al norte geográfico exacto.", false, "Una brújula responde al campo magnético terrestre.", "Geografía", 1, "https://www.nationalgeographic.org/encyclopedia/compass/"),
  trueFalse("Un año luz mide tiempo.", false, "Un año luz es una unidad de distancia.", "Ciencia", 1, "https://science.nasa.gov/exoplanets/"),
  trueFalse("El sistema solar tiene ocho planetas.", true, "La Unión Astronómica Internacional reconoce ocho planetas.", "Ciencia", 1, "https://science.nasa.gov/solar-system/"),
] as const;
