...
The deterministic very-easy guess-word bank contains fourteen distinct curated answers, and a generator test enforces that its fourteen-day reserve does not repeat an answer. The easy quiz bank contains seventy curated questions and assigns five disjoint prompts to each of fourteen consecutive editions. The word-search bank contains seventy curated words and assigns five disjoint words to each of fourteen consecutive editions. The crossword bank contains fourteen validated three-answer layouts with no repeated answer across that reserve. True/false uses three balanced curated statements per edition: forty-two unique statements with twenty-one true and twenty-one false across fourteen days.
