...
| Quiz, verdadero/falso y crucigrama públicos, guardado y revisión sin filtraciones | Implementada | `apps/web/app/jugar`, `apps/mobile`, pruebas E2E 2, 3 y 6 |
...
|---|---|
| `pnpm test:e2e` | 6 de 6 pruebas correctas |
