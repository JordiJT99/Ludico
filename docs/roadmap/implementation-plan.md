...
| US-002 | completada | `pnpm check`, hooks, `.env.example`, builds web/Expo/API/worker, comprobación de imports compilados y objetivos OCI API/worker/web sin secretos; [CI remota verde](https://github.com/JordiJT99/Ludico/actions/runs/30495177167) en `07df1ce` con SCA/secret scan |
